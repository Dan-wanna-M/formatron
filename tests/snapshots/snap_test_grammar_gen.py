...
snapshots['test_infer_mapping 1'] = '''
integer ::= #"-?(0|[1-9]\\d*)";
...
start_related_queries_value_0 ::= object_begin '114' colon start_related_queries_value_0_114 object_end;
start_related_queries_value_0_114 ::= integer;
